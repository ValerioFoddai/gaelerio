...
CREATE TYPE expense_category AS ENUM ('deposit', 'withdrawal', 'transfer');

-- Create transactions table with new column name
...
CREATE INDEX idx_transactions_category ON public.transactions(expense_category);
